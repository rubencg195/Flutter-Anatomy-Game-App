import 'package:anatomika/MainPage.dart';
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new IconButton(
                ...
                onPressed: () => Navigator.of(context).pushAndRemoveUntil(new MaterialPageRoute(builder: (BuildContext context) => new Main()), (Route route) => route == null)
            )
          ],
        )
    );
